    ...
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-900 transition-colors duration-300">
          ...
          >
            <div className="flex items-center justify-between gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <h2
                  className={`font-black text-gray-900 dark:text-white leading-tight transition-all duration-300 ${
      ...
      <CollapsibleSection
        ...
        header={(isOpen, toggle) => (
          ...
          >
            <div
              className={`relative transition-all duration-300 ${isOpen ? "flex flex-col items-center text-center gap-1.5" : "flex items-center justify-between gap-4"}`}
            >
              <div className="flex flex-col gap-1.5">
                <p className="text-xs font-semibold text-[#1A3879] dark:text-blue-400 tracking-widest uppercase">
      ...
      >
        ...
        >
          {(Array.isArray(characteristics) ? characteristics : []).map(
            ({ title, text }, i) => (
              <motion.div
                key={title}
                variants={fadeUp}
      ...
      >
        ...
        >
          <motion.div
            variants={fadeUp}
            className="flex flex-col gap-4 text-gray-600 dark:text-zinc-400 leading-relaxed"
          >
          ...
          <motion.div variants={fadeUp} className="flex flex-col gap-5">
            {(Array.isArray(spectrumBars) ? spectrumBars : []).map(
              ({ label, pct }, i) => (
      ...
      <CollapsibleSection
        ...
        header={(isOpen, toggle) => (
          ...
          >
            <div
              className={`max-w-7xl mx-auto relative transition-all duration-300 ${isOpen ? "flex flex-col items-center text-center gap-1.5" : "flex items-center justify-between gap-4"}`}
            >
              <div className="flex flex-col gap-1.5">
                ...
                <h2
                  className={`font-black text-white leading-tight transition-all duration-300 ${
                    isOpen ? "text-3xl lg:text-5xl mb-8" : "text-xl lg:text-2xl"
                  }`}
                >
            ...
            {(Array.isArray(stats) ? stats : []).map(
              ({ number, label, sub }, i) => (
                ...
                >
                  ...
                  <p className="font-semibold text-base leading-snug text-white/90">
                    {label}
                  </p>
      ...
      >
        ...
        >
          <motion.p
            variants={fadeUp}
            className="text-lg text-gray-600 dark:text-zinc-400 max-w-2xl leading-relaxed"
          >
            {t("pages.tea.diagnosis.intro")}
          </motion.p>

          <div className="flex flex-col">
            {(Array.isArray(diagnosisSteps) ? diagnosisSteps : []).map(
              ({ step, title, text }, i) => (
                <motion.div
                  key={step}
                  variants={fadeUp}
